    ...
    public class OrganizationService {
        ...
        public void assignRolesToUserInOrganization(String organizationId, String userId, List<String> roleIds) {
            String token = auth0Client.getAccessToken();
            ...
            buildClient(token)
                    .post()
                    .uri("/organizations/{organizationId}/members/{userId}/roles", organizationId, userId)
                    .contentType(MediaType.APPLICATION_JSON)
                    .bodyValue(body)
                    .retrieve()
                    .toBodilessEntity()
